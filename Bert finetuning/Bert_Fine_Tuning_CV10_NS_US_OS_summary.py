...
data_directory = "Temp_Data_Files"
...
def create_files_for_Kfold(nb_csv, df_test, SamplingMode):
    if SamplingMode == 0:
        data_directory = "Temp_Data_Files" + os.path.sep + "NotSampled"
    if SamplingMode == 1:
        data_directory = "Temp_Data_Files" + os.path.sep + "UnderSampled"
    if SamplingMode == 2:
        data_directory = "Temp_Data_Files" + os.path.sep + "OverSampled"
